...
namespace AIO.Data.Migrations
{
    ...
    [Migration("20240320121540_CommentsAddedToEntityClasses")]
    partial class CommentsAddedToEntityClasses
    {
            ...
            modelBuilder.Entity("AIO.Data.Models.Product", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("c05e3d7a-2ed6-4722-8405-659bd38cf5f6"),
                            ...
                            EndTime = new DateTime(2024, 3, 27, 12, 15, 39, 396, DateTimeKind.Utc).AddTicks(3476),
                            ...
                            IsActive = false,
                            Price = 10000m,
                            StartTime = new DateTime(2024, 3, 20, 12, 15, 39, 396, DateTimeKind.Utc).AddTicks(3474),
                            Title = "Car"
                        },
                        new
                        {
                            Id = new Guid("425e6acb-f7e8-42e2-82ad-ff70c31518b8"),
                            AgentId = new Guid("db47b449-630e-4857-bc80-34a6c3e8e822"),
                            BuyerId = new Guid("ab6d096a-0ccc-49ae-2db2-08dc32d4f58a"),
                            CategoryId = 2,
                            Description = "A bike for sale",
                            EndTime = new DateTime(2024, 3, 27, 12, 15, 39, 396, DateTimeKind.Utc).AddTicks(3500),
                            ImageUrl = "https://images.pexels.com/photos/100582/pexels-photo-100582.jpeg?auto=compress&cs=tinysrgb&dpr=1&w=500",
                            IsActive = false,
                            Price = 100m,
                            StartTime = new DateTime(2024, 3, 20, 12, 15, 39, 396, DateTimeKind.Utc).AddTicks(3500),
                            Title = "Bike"
                        },
                        new
                        {
                            Id = new Guid("e9f76e18-a369-4005-8d34-826eb192816a"),
                            AgentId = new Guid("db47b449-630e-4857-bc80-34a6c3e8e822"),
                            CategoryId = 3,
                            Description = "A house for sale",
                            EndTime = new DateTime(2024, 3, 27, 12, 15, 39, 396, DateTimeKind.Utc).AddTicks(3516),
                            ...
                            IsActive = false,
                            Price = 100000m,
                            StartTime = new DateTime(2024, 3, 20, 12, 15, 39, 396, DateTimeKind.Utc).AddTicks(3515),
                            Title = "House"
                        });
                });
