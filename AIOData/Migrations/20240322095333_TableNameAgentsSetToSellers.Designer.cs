...
namespace AIO.Data.Migrations
{
    ...
    [Migration("20240322095333_TableNameAgentsSetToSellers")]
    partial class TableNameAgentsSetToSellers
    {
            ...
            modelBuilder.Entity("AIO.Data.Models.Product", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("72d063da-b55f-4acd-994b-c73dca06f8fc"),
                            AgentId = new Guid("db47b449-630e-4857-bc80-34a6c3e8e822"),
                            BuyerId = new Guid("ab6d096a-0ccc-49ae-2db2-08dc32d4f58a"),
                            CategoryId = 1,
                            CreatedOn = new DateTime(2024, 3, 22, 9, 53, 33, 73, DateTimeKind.Utc).AddTicks(3941),
                            Description = "A car for sale",
                            ExpirationDate = new DateTime(2024, 3, 29, 9, 53, 33, 73, DateTimeKind.Utc).AddTicks(3943),
                        ...
                        new
                        {
                            Id = new Guid("58d2ff18-9dd8-4ad8-a26c-866d7af9b5fa"),
                            AgentId = new Guid("db47b449-630e-4857-bc80-34a6c3e8e822"),
                            BuyerId = new Guid("ab6d096a-0ccc-49ae-2db2-08dc32d4f58a"),
                            CategoryId = 2,
                            CreatedOn = new DateTime(2024, 3, 22, 9, 53, 33, 73, DateTimeKind.Utc).AddTicks(3958),
                            Description = "A bike for sale",
                            ExpirationDate = new DateTime(2024, 3, 29, 9, 53, 33, 73, DateTimeKind.Utc).AddTicks(3959),
                        ...
                        new
                        {
                            Id = new Guid("9c59f678-99a6-427b-bbfc-5e9cd172bf6f"),
                            AgentId = new Guid("db47b449-630e-4857-bc80-34a6c3e8e822"),
                            CategoryId = 3,
                            CreatedOn = new DateTime(2024, 3, 22, 9, 53, 33, 73, DateTimeKind.Utc).AddTicks(3962),
                            Description = "A house for sale",
                            ExpirationDate = new DateTime(2024, 3, 29, 9, 53, 33, 73, DateTimeKind.Utc).AddTicks(3962),
