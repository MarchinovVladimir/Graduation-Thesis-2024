...
namespace AIO.Data.Migrations
{
    ...
    [Migration("20240326160323_AddedIsSoldPropertyToProduct")]
    partial class AddedIsSoldPropertyToProduct
    {
            ...
            modelBuilder.Entity("AIO.Data.Models.Product", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("8fde732a-5974-48a0-908f-738ad9acf222"),
                            BuyerId = new Guid("ab6d096a-0ccc-49ae-2db2-08dc32d4f58a"),
                            CategoryId = 1,
                            CreatedOn = new DateTime(2024, 3, 26, 16, 3, 23, 73, DateTimeKind.Utc).AddTicks(669),
                            Description = "A car for sale",
                            ExpirationDate = new DateTime(2024, 4, 2, 16, 3, 23, 73, DateTimeKind.Utc).AddTicks(670),
                        ...
                        new
                        {
                            Id = new Guid("60643e9a-cd79-4f54-8b47-621503aa5c31"),
                            BuyerId = new Guid("ab6d096a-0ccc-49ae-2db2-08dc32d4f58a"),
                            CategoryId = 2,
                            CreatedOn = new DateTime(2024, 3, 26, 16, 3, 23, 73, DateTimeKind.Utc).AddTicks(698),
                            Description = "A bike for sale",
                            ExpirationDate = new DateTime(2024, 4, 2, 16, 3, 23, 73, DateTimeKind.Utc).AddTicks(698),
                        ...
                        new
                        {
                            Id = new Guid("cf1c4ba1-e2c6-453c-9739-98797913211d"),
                            CategoryId = 3,
                            CreatedOn = new DateTime(2024, 3, 26, 16, 3, 23, 73, DateTimeKind.Utc).AddTicks(702),
                            Description = "A house for sale",
                            ExpirationDate = new DateTime(2024, 4, 2, 16, 3, 23, 73, DateTimeKind.Utc).AddTicks(702),
