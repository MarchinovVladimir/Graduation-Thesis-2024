...
namespace AIO.Data.Migrations
{
    ...
    [Migration("20240320094644_ApplicationUserPropertyRenamed")]
    partial class ApplicationUserPropertyRenamed
    {
            ...
            modelBuilder.Entity("AIO.Data.Models.Product", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("464ecab9-667e-4906-acae-8baacfa8fc5a"),
                            ...
                            EndTime = new DateTime(2024, 3, 27, 9, 46, 43, 698, DateTimeKind.Utc).AddTicks(970),
                            ...
                            IsActive = false,
                            Price = 10000m,
                            StartTime = new DateTime(2024, 3, 20, 9, 46, 43, 698, DateTimeKind.Utc).AddTicks(966),
                            Title = "Car"
                        },
                        new
                        {
                            Id = new Guid("1141e879-da34-4c83-add0-7006c1dd06d6"),
                            AgentId = new Guid("db47b449-630e-4857-bc80-34a6c3e8e822"),
                            BuyerId = new Guid("ab6d096a-0ccc-49ae-2db2-08dc32d4f58a"),
                            CategoryId = 2,
                            Description = "A bike for sale",
                            EndTime = new DateTime(2024, 3, 27, 9, 46, 43, 698, DateTimeKind.Utc).AddTicks(1054),
                            ImageUrl = "https://images.pexels.com/photos/100582/pexels-photo-100582.jpeg?auto=compress&cs=tinysrgb&dpr=1&w=500",
                            IsActive = false,
                            Price = 100m,
                            StartTime = new DateTime(2024, 3, 20, 9, 46, 43, 698, DateTimeKind.Utc).AddTicks(1053),
                            Title = "Bike"
                        },
                        new
                        {
                            Id = new Guid("faf41163-9dd7-4374-893a-8d4dc325526f"),
                            AgentId = new Guid("db47b449-630e-4857-bc80-34a6c3e8e822"),
                            CategoryId = 3,
                            Description = "A house for sale",
                            EndTime = new DateTime(2024, 3, 27, 9, 46, 43, 698, DateTimeKind.Utc).AddTicks(1069),
                            ...
                            IsActive = false,
                            Price = 100000m,
                            StartTime = new DateTime(2024, 3, 20, 9, 46, 43, 698, DateTimeKind.Utc).AddTicks(1069),
                            Title = "House"
                        });
                });
