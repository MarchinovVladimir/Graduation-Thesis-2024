...
namespace AIO.Data.Migrations
{
    ...
    [Migration("20240301072155_fixCreatingProductDateValue")]
    partial class fixCreatingProductDateValue
    {
            ...
            modelBuilder.Entity("AIO.Data.Models.Product", b =>
                {
                    ...
                    b.Property<bool>("IsAuctionClosed")
                        .HasColumnType("bit")
                        .HasComment("The product's auction status.");
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("54cf4523-bbeb-4aea-adc1-8c34b801cfc2"),
                            ...
                            EndTime = new DateTime(2024, 3, 8, 7, 21, 55, 89, DateTimeKind.Utc).AddTicks(3002),
                            ...
                            OpeningBid = 10000m,
                            StartTime = new DateTime(2024, 3, 1, 7, 21, 55, 89, DateTimeKind.Utc).AddTicks(3000),
                            Title = "Car"
                        },
                        new
                        {
                            Id = new Guid("ec029585-765d-4f2d-8c19-7ed3c9090dbc"),
                            AgentId = new Guid("db47b449-630e-4857-bc80-34a6c3e8e822"),
                            BuyerId = new Guid("ab6d096a-0ccc-49ae-2db2-08dc32d4f58a"),
                            CategoryId = 2,
                            CurrentBid = 120m,
                            Description = "A bike for sale",
                            EndTime = new DateTime(2024, 3, 8, 7, 21, 55, 89, DateTimeKind.Utc).AddTicks(3031),
                            ImageUrl = "https://images.pexels.com/photos/100582/pexels-photo-100582.jpeg?auto=compress&cs=tinysrgb&dpr=1&w=500",
                            IsAuctionClosed = false,
                            OpeningBid = 100m,
                            StartTime = new DateTime(2024, 3, 1, 7, 21, 55, 89, DateTimeKind.Utc).AddTicks(3031),
                            Title = "Bike"
                        },
                        new
                        {
                            Id = new Guid("f00af202-3817-40bf-a786-ded511a0f8d9"),
                            AgentId = new Guid("db47b449-630e-4857-bc80-34a6c3e8e822"),
                            CategoryId = 3,
                            CurrentBid = 120000m,
                            Description = "A house for sale",
                            EndTime = new DateTime(2024, 3, 8, 7, 21, 55, 89, DateTimeKind.Utc).AddTicks(3037),
                            ...
                            IsAuctionClosed = false,
                            OpeningBid = 100000m,
                            StartTime = new DateTime(2024, 3, 1, 7, 21, 55, 89, DateTimeKind.Utc).AddTicks(3037),
                            Title = "House"
                        });
                });
