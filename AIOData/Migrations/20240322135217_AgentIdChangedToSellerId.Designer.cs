...
namespace AIO.Data.Migrations
{
    ...
    [Migration("20240322135217_AgentIdChangedToSellerId")]
    partial class AgentIdChangedToSellerId
    {
            ...
            modelBuilder.Entity("AIO.Data.Models.Product", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("43e9ec5b-49a4-4936-af29-34580a4f4b84"),
                            BuyerId = new Guid("ab6d096a-0ccc-49ae-2db2-08dc32d4f58a"),
                            CategoryId = 1,
                            CreatedOn = new DateTime(2024, 3, 22, 13, 52, 17, 95, DateTimeKind.Utc).AddTicks(6516),
                            Description = "A car for sale",
                            ExpirationDate = new DateTime(2024, 3, 29, 13, 52, 17, 95, DateTimeKind.Utc).AddTicks(6518),
                        ...
                        new
                        {
                            Id = new Guid("cd2c9527-5691-45cd-b6f5-272706da21fb"),
                            BuyerId = new Guid("ab6d096a-0ccc-49ae-2db2-08dc32d4f58a"),
                            CategoryId = 2,
                            CreatedOn = new DateTime(2024, 3, 22, 13, 52, 17, 95, DateTimeKind.Utc).AddTicks(6532),
                            Description = "A bike for sale",
                            ExpirationDate = new DateTime(2024, 3, 29, 13, 52, 17, 95, DateTimeKind.Utc).AddTicks(6532),
                        ...
                        new
                        {
                            Id = new Guid("c243d11e-6393-44e1-b486-2b423454714d"),
                            CategoryId = 3,
                            CreatedOn = new DateTime(2024, 3, 22, 13, 52, 17, 95, DateTimeKind.Utc).AddTicks(6535),
                            Description = "A house for sale",
                            ExpirationDate = new DateTime(2024, 3, 29, 13, 52, 17, 95, DateTimeKind.Utc).AddTicks(6535),
