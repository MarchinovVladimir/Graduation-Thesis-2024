...
namespace AIO.Data.Migrations
{
    ...
    [Migration("20240301074818_addIsActiveColomnForSoftDeletiningProducts")]
    partial class addIsActiveColomnForSoftDeletiningProducts
    {
            ...
            modelBuilder.Entity("AIO.Data.Models.Product", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("5d857b0c-d5de-4b6a-9450-c130413cc91a"),
                            ...
                            EndTime = new DateTime(2024, 3, 8, 7, 48, 17, 492, DateTimeKind.Utc).AddTicks(6187),
                            ...
                            OpeningBid = 10000m,
                            StartTime = new DateTime(2024, 3, 1, 7, 48, 17, 492, DateTimeKind.Utc).AddTicks(6185),
                            Title = "Car"
                        },
                        new
                        {
                            Id = new Guid("99b6adac-69f3-48d1-9891-42fd07f74b6d"),
                            AgentId = new Guid("db47b449-630e-4857-bc80-34a6c3e8e822"),
                            BuyerId = new Guid("ab6d096a-0ccc-49ae-2db2-08dc32d4f58a"),
                            CategoryId = 2,
                            CurrentBid = 120m,
                            Description = "A bike for sale",
                            EndTime = new DateTime(2024, 3, 8, 7, 48, 17, 492, DateTimeKind.Utc).AddTicks(6220),
                            ImageUrl = "https://images.pexels.com/photos/100582/pexels-photo-100582.jpeg?auto=compress&cs=tinysrgb&dpr=1&w=500",
                            IsActive = false,
                            IsAuctionClosed = false,
                            OpeningBid = 100m,
                            StartTime = new DateTime(2024, 3, 1, 7, 48, 17, 492, DateTimeKind.Utc).AddTicks(6220),
                            Title = "Bike"
                        },
                        new
                        {
                            Id = new Guid("bee5022d-489a-4561-8913-76d9b004f38c"),
                            AgentId = new Guid("db47b449-630e-4857-bc80-34a6c3e8e822"),
                            CategoryId = 3,
                            CurrentBid = 120000m,
                            Description = "A house for sale",
                            EndTime = new DateTime(2024, 3, 8, 7, 48, 17, 492, DateTimeKind.Utc).AddTicks(6224),
                            ...
                            IsAuctionClosed = false,
                            OpeningBid = 100000m,
                            StartTime = new DateTime(2024, 3, 1, 7, 48, 17, 492, DateTimeKind.Utc).AddTicks(6224),
                            Title = "House"
                        });
                });
